...
const DisplayAlbum = () => {
  ...
  return (
    <>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 mt-10 mb-4 pl-2 pt-1 text-[#a7a7a7]'>
      ...
      <hr />
      {
        songsData.map((item, index)=>(
            <div onClick={() => playWithId(item.id)} key={index} className='grid grid-cols-2 sm:grid-cols-3 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
                <p className='text-white mt-1 inline-flex'>
